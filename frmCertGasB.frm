...
Begin VB.Form frmCertGasB 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Certificado Gasóleo B"
   ClientHeight    =   4845
   ClientLeft      =   45
   ClientTop       =   2430
   ClientWidth     =   7185
   Icon            =   "frmCertGasB.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4845
   ...
   Begin VB.Frame FrameCobros 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   4
         Left            =   1560
         MouseIcon       =   "frmCertGasB.frx":000C
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   0
         Left            =   1560
         MouseIcon       =   "frmCertGasB.frx":0274
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   1
         Left            =   1545
         MouseIcon       =   "frmCertGasB.frx":03C6
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar cliente"
         Top             =   1215
         Width           =   240
...
If Not DatosOK Then Exit Sub
    ...
    Ajena = ""
    Ajena = DevuelveDesdeBDNew(cPTours, "scoope", "tipfactu", "codcoope", txtCodigo(4).Text, "N")
...
'    If Not AnyadirAFormula(cadSelect, Codigo) Then Exit Sub
    ...
    If Not AnyadirAFormula(cadFormula, "{ssocio.codcoope} = " & txtCodigo(4).Text) Then Exit Sub
    If Not AnyadirAFormula(cadSelect, "{ssocio.codcoope} = " & txtCodigo(4).Text) Then Exit Sub
    
    'Comprobar si hay registros a Mostrar antes de abrir el Informe
    cadTABLA = tabla & " INNER JOIN ssocio ON " & tabla & ".codsocio=ssocio.codsocio "
    
    If tabla = "schfacr" Then
        cadTABLA = cadTABLA & ", slhfacr, sartic "
        cad = "{sartic.codartic} = {slhfacr.codartic} and {slhfacr.letraser} = {schfacr.letraser} and {slhfacr.numfactu} = {schfacr.numfactu} and {slhfacr.fecfactu} = {schfacr.fecfactu} "
    Else
    ...
    If HayRegParaInforme(cadTABLA, cadSelect) Then
        cadTitulo = "Certificado de Gasoleo B"
       ...
       indRPT = 3 'Certificado de gasoleo B
        
       If Not PonerParamRPT(indRPT, cadParam, numParam, nomDocu) Then Exit Sub
       'Nombre fichero .rpt a Imprimir
       
       If Ajena = "2" Then
            nomDocu = Replace(nomDocu, ".rpt", "Aj" & "C" & Format(txtCodigo(4).Text, "00") & ".rpt")
       End If
       
       ' he añadido estas dos lineas para que llame al rpt correspondiente
       frmImprimir.NombreRPT = nomDocu
       cadNombreRPT = nomDocu  ' "rCertGasolB.rpt"
       LlamarImprimir
...
Private Function DatosOK() As Boolean
    ...
    If txtCodigo(4).Text = "" Then
        MsgBox "Debe introducir el colectivo.", vbExclamation
        DatosOK = False
    End If
End Function
