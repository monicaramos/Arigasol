...
Begin VB.Form frmManBanco 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   10
         TabIndex        =   14
         Tag             =   "Teléfono|T|S|||sbanco|telbanco|||"
         Top             =   480
         Width           =   1695
      End
      Begin VB.TextBox txtAux 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   8
      Tag             =   "Código Postal|T|S|||sbanco|codposta|||"
      Top             =   960
      Width           =   1095
   End
   Begin VB.TextBox txtAux 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   9
      Tag             =   "Población|T|S|||sbanco|pobbanco|||"
      Top             =   1320
      Width           =   4185
   End
   Begin VB.TextBox txtAux 
...
'    Set DataGrid1.DataSource = adodc1 ' per a que no ixca l'error de "la fila actual no está disponible"
    ...
    tots = "S|txtAux(0)|T|Cód.|650|;S|txtAux(1)|T|Denominación|1957|;S|txtAux(17)|T|IBAN|800|;S|txtAux(2)|T|Entidad|800|;"
