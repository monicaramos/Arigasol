...
Begin VB.Form frmEstArticRegaixo 
   ...
   ClientTop       =   2430
   ClientWidth     =   7125
   Icon            =   "frmEstArticRegaixo.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3210
   ...
   Begin VB.Frame FrameCobros 
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   2
         Left            =   1440
         Picture         =   "frmEstArticRegaixo.frx":000C
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   3
         Left            =   1440
         Picture         =   "frmEstArticRegaixo.frx":0097
         ToolTipText     =   "Buscar fecha"
         Top             =   1440
         Width           =   240
      End
   End
End
Attribute VB_Name = "frmEstArticRegaixo"
...
InicializarVbles
    ...
    numParam = numParam + 1
    cadParam = cadParam & "codusu= " & vSesion.Codigo & "|"
    numParam = numParam + 1
    ...
    sql = "SELECT count(*) "
    sql = sql & "from slhfac, schfac, ssocio, sfamia, sartic "
    sql = sql & "where sfamia.tipfamia = 1 and sfamia.codfamia = sartic.codfamia and "
    sql = sql & " schfac.codsocio = ssocio.codsocio and "
    sql = sql & " slhfac.letraser = schfac.letraser and slhfac.numfactu = schfac.numfactu and "
    sql = sql & " slhfac.fecfactu = schfac.fecfactu and slhfac.codartic = sartic.codartic "
    ...
    If TotalRegistros(sql) = 0 Then
        MsgBox "No existe registros entre esos limites", vbExclamation
        Exit Sub
    Else
        CargarTemporal
        cadTitulo = "Estadística de Artículos"
        cadNombreRPT = "rEstArticulos.rpt"
