...
'    cad = DevuelveDesdeBD("smtpHost", "spara1", "fechaini", Format(vParam.fechaini, FormatoFecha), "F")
    ...
    Else
        If vParamAplic.EnvioDesdeOutlook Then
            cad = "OK"
        Else
            cad = DevuelveDesdeBDNew(cPTours, "sparam", "smtphost", "codparam", "1", "N")
        End If
    End If
...
Dim miRsAux As ADODB.Recordset
    ...
    cad = "Select * from usuarios.usuarios where login = " & DBSet(vSesion.Login, "T")
...
'            Tabla = NomTabla
            Titulo = "Socios"
        Case "proveedor"
            cad = cad & "Código|codprove|N|000000|9·"
            cad = cad & "Nombre|nomprove|T||29·"
            cad = cad & "Nom.Comer.|nomcomer|T||29·"
            cad = cad & "E-mail|" & NomCampo & "|T||33·"
'            Tabla = NomTabla
            Titulo = "Proveedores"
        Case "straba"
            cad = cad & "Código|codtraba|N|0000|9·"
            cad = cad & "Nombre|nomtraba|T||44·"
            cad = cad & "E-mail|" & NomCampo & "|T||44·"
'            Tabla = NomTabla
            Titulo = "trabajadores"
    End Select
    tabla = NomTabla
    Conexion = cPTours    'Conexión a BD: Arigasol
...
'        HaDevueltoDatos = False
        '###A mano
        If NomTabla = "ssocio" Or NomTabla = "straba" Then
        ...
        frmB.vTitulo = Titulo
        frmB.vSelElem = 1
'--[Monica]01/08/2011: quitadas estas dos lineas
    ...
    For i = 1 To Lis.Count
        ...
        While Not Rs.EOF
            ...
            If Opcion = 4 Then
                ...
                cad = App.path & "\temp\" & Trim(Rs!nombre1) & Format(Rs!Importe1, "0000000") & Format(Rs!Codigo1, "000000") & ".pdf"
            Else
...
On Error GoTo EMulti2
    ...
    cad = "select * from tmpnlotes where codusu =" & vSesion.Codusu
    ...
    For i = 1 To Lis.Count
        ...
        Caption = "Enviar E-MAIL (" & i & " de " & Lis.Count & ")"
        DoEvents
        cad = "select * from tmpnlotes where codusu =" & vSesion.Codigo
