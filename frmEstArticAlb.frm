...
Begin VB.Form frmEstArticAlb 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Resumen Ventas Artículos Albaranes"
   ClientHeight    =   4560
   ClientLeft      =   45
   ClientTop       =   2430
   ClientWidth     =   7185
   Icon            =   "frmEstArticAlb.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4560
   ...
   Begin VB.Frame FrameCobros 
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   2
         Left            =   1530
         Picture         =   "frmEstArticAlb.frx":000C
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   3
         Left            =   1530
         Picture         =   "frmEstArticAlb.frx":0097
         ToolTipText     =   "Buscar fecha"
         Top             =   2280
         Width           =   240
      End
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   0
         Left            =   1560
         MouseIcon       =   "frmEstArticAlb.frx":0122
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   1
         Left            =   1545
         MouseIcon       =   "frmEstArticAlb.frx":0274
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar familia"
         Top             =   1215
         Width           =   240
   ...
   End
End
Attribute VB_Name = "frmEstArticAlb"
...
InicializarVbles
    ...
    If txtCodigo(2).Text = txtCodigo(3) And txtCodigo(2).Text <> "" Then
        If Not AnyadirAFormula(cadSelect, "{scaalb.codturno}=" & txtCodigo(4).Text) Then Exit Sub
        If Not AnyadirAFormula(cadFormula, "{scaalb.codturno}=" & txtCodigo(4).Text) Then Exit Sub
    End If
    
    'Comprobar si hay registros a Mostrar antes de abrir el Informe
    cadTABLA = tabla & " INNER JOIN sartic ON " & tabla & ".codartic=sartic.codartic "
    cadTABLA = cadTABLA & " INNER JOIN sfamia ON " & "sartic.codfamia=sfamia.codfamia "
    
    If HayRegParaInforme(cadTABLA, cadSelect) Then
       cadTitulo = "Resumen Ventas Artículos Albaranes"
       cadNombreRPT = "rEstArticAlb.rpt"
       LlamarImprimir
       'AbrirVisReport
    End If
End Sub
    ...
    Select Case Index
        Case 0
           ' "____________________________________________________________"
            vCadena = "El turno sólo tendrá efecto cuando la fecha desde y hasta coincidan." & vbCrLf & _
                       vbCrLf
