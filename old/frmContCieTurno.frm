...
Dim CtaDifer As String
    ...
    If numlinea > 0 Then
        ...
        Obs = "Cierre Turno de fecha " & Format(txtcodigo(0).Text, "dd/mm/yyyy") & " y turno T-" & Format(txtcodigo(1).Text, "0")
        ...
        If b Then
            ...
            numdocum = Format(CDate(txtcodigo(0).Text), "ddmmyy") & "-T" & Format(txtcodigo(1).Text, "0")
'            ampliacion = "Cierre Turno " & Format(txtcodigo(0).Text, "dd/mm/yyyy") & " T-" & Format(txtcodigo(1).Text, "0")
            ampliacion = "CTu." & Format(txtcodigo(0).Text, "dd/mm/yy") & "-T" & Format(txtcodigo(1).Text, "0")
