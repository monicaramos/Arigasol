...
Begin VB.Form frmManMovim 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripción del Movimiento|T|N|||stipom|nomtipom|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código de Movimiento|T|N|||stipom|codtipom||S|"
      Top             =   4920
      Width           =   800
   End
...
'    Set DataGrid1.DataSource = adodc1
    ...
    tots = "S|txtAux(0)|T|Código|832|;S|txtAux(1)|T|Descripción|3000|;"
...
'         If Datos <> "" Then
'            MsgBox "Ya existe el Código de Actividad: " & txtAux(0).Text, vbExclamation
'            DatosOk = False
'            PonerFoco txtAux(0)
'            Exit Function
'        End If
