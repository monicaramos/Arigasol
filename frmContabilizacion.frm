...
Begin VB.Form frmContabilizacion 
   ...
   ClientTop       =   2430
   ClientWidth     =   7185
   Icon            =   "frmContabilizacion.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6315
   ...
   Begin VB.Frame FrameCobros 
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   7
         Left            =   4110
         Picture         =   "frmContabilizacion.frx":000C
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   8
         Left            =   1470
         MouseIcon       =   "frmContabilizacion.frx":0097
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   6
         Left            =   1470
         Picture         =   "frmContabilizacion.frx":01E9
         ToolTipText     =   "Buscar fecha"
         Top             =   630
         Width           =   240
      End
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   5
         Left            =   1485
         MouseIcon       =   "frmContabilizacion.frx":0274
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar cliente"
         Top             =   4035
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   4
         Left            =   1500
         MouseIcon       =   "frmContabilizacion.frx":03C6
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar cliente"
         Top             =   3660
         Width           =   240
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   2
         Left            =   1470
         Picture         =   "frmContabilizacion.frx":0518
         ToolTipText     =   "Buscar fecha"
         Top             =   2760
         Width           =   240
      End
      Begin VB.Image imgFec 
         ...
         Index           =   3
         Left            =   1470
         Picture         =   "frmContabilizacion.frx":05A3
         ToolTipText     =   "Buscar fecha"
         Top             =   3120
         Width           =   240
      End
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   0
         Left            =   1470
         MouseIcon       =   "frmContabilizacion.frx":062E
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar cliente"
         Top             =   1830
         Width           =   240
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   1
         Left            =   1470
         MouseIcon       =   "frmContabilizacion.frx":0780
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar cliente"
         Top             =   2220
         Width           =   240
    ...
    If HayRegParaInforme(cadTABLA, cadSelect) Then
          ...
          If Not PendientePasarTPV(cadSelect) Then
              If Not PendienteCierresTurno(Trim(txtCodigo(2).Text), Trim(txtCodigo(3).Text)) Then
                    If Option1(0).Value Or Option1(2).Value Then Facturacion txtCodigo(2).Text, txtCodigo(3).Text, txtCodigo(0).Text, txtCodigo(1).Text, txtCodigo(4).Text, txtCodigo(5).Text, CDate(txtCodigo(6).Text), clitar,pb1,
                    If Option1(1).Value Or Option1(2).Value Then Facturacion txtCodigo(2).Text, txtCodigo(3).Text, txtCodigo(0).Text, txtCodigo(1).Text, txtCodigo(4).Text, txtCodigo(5).Text, CDate(txtCodigo(6).Text), CliTar, pb1
              End If
          End If
    End If
End Sub
