...
Begin VB.Form frmEstConsFec 
   ...
   Begin VB.Frame FrameCobros 
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   2
         Left            =   1530
         Picture         =   "frmEstConsFec.frx":000C
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   3
         Left            =   1530
         Picture         =   "frmEstConsFec.frx":0097
         ToolTipText     =   "Buscar fecha"
         Top             =   2280
         Width           =   240
      End
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   0
         Left            =   1560
         MouseIcon       =   "frmEstConsFec.frx":0122
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   1
         Left            =   1545
         MouseIcon       =   "frmEstConsFec.frx":0274
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar cliente"
         Top             =   1215
         Width           =   240
   ...
   End
End
Attribute VB_Name = "frmEstConsFec"
...
Dim i As Byte
    ...
    cadTABLA = tabla & " INNER JOIN schfac ON " & "slhfac.letraser=schfac.letraser AND slhfac.numfactu=schfac.numfactu AND slhfac.fecfactu=schfac.fecfactu"
    
    If Check1.Value = 1 Then
        cadTABLA = Replace(cadTABLA, "schfac", "schfacr")
        cadTABLA = Replace(cadTABLA, "slhfac", "slhfacr")
        cadSelect = Replace(cadSelect, "schfac", "schfacr")
        cadSelect = Replace(cadSelect, "slhfac", "slhfacr")
        cadFormula = Replace(cadFormula, "schfac", "schfacr")
        cadFormula = Replace(cadFormula, "slhfac", "slhfacr")
        cadNombreRPT = "rEstConsFec1.rpt"
    Else
          cadNombreRPT = "rEstConsFec.rpt"
    End If
    
    If HayRegParaInforme(cadTABLA, cadSelect) Then
          cadTitulo = "Consumo entre Fechas"
          LlamarImprimir
    End If
...
Private Sub AbrirfrmClientes(indice As Integer)
    ...
    frmCli.CodigoActual = DevuelveDesdeBDNew(cPTours, "ssocio", "codsocio", "codsocio", txtCodigo(indCodigo), "N")
    frmCli.Show vbModal
    Set frmCli = Nothing
End Sub
