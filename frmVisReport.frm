...
'    Informe = "C:\Programas\Ariges 4\Informes\rptMarcas.rpt"
    ...
    For i = 1 To mrpt.Database.Tables.Count
       ...
       If InStr(1, mrpt.Database.Tables(i).Name, "_") = 0 Then
               '[Monica]13/03/2015: antes comentada la instrucccion de abajo y activa la comentada
               mrpt.Database.Tables(i).Location = vSesion.CadenaConexion & "." & mrpt.Database.Tables(i).Name
...
'                    smrpt.RecordSelectionFormula = mrpt.RecordSelectionFormula
                    ...
                    For i = 1 To smrpt.Database.Tables.Count
                         smrpt.Database.Tables(i).SetLogOnInfo "Arigasol", vSesion.CadenaConexion, "root", "aritel"
                    
                         If (InStr(1, smrpt.Database.Tables(i).Name, "_") = 0) Then
                            smrpt.Database.Tables(i).Location = vSesion.CadenaConexion & "." & smrpt.Database.Tables(i).Name
                         End If
                    Next i
                'End If
             End If
        ...
        For Each crxObject In crxSection.ReportObjects
             If TypeOf crxObject Is SubreportObject Then
                ...
                For i = 1 To smrpt.Database.Tables.Count 'para cada tabla
                    ...
                    If smrpt.Database.Tables(i).ConnectionProperties.Item("DSN") = "arigasol" Then
                        smrpt.Database.Tables(i).SetLogOnInfo "arigasol", "arigasol", "root", "aritel"
                        If (InStr(1, smrpt.Database.Tables(i).Name, "_") = 0) Then
                           smrpt.Database.Tables(i).Location = "arigasol" & "." & smrpt.Database.Tables(i).Name
                        End If
