...
Begin VB.Form frmManRangos 
   ...
   Caption         =   "Rangos Horarios para Estadísticas"
   ClientHeight    =   7200
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6435
   ...
   Begin VB.Frame FrameAux0 
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   6
         TabIndex        =   18
         Tag             =   "Código|N|N|0|999|linrangos|codigo|000|S|"
         Top             =   4080
         Visible         =   0   'False
         Width           =   975
      End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox text1 
         ...
         MaxLength       =   6
         TabIndex        =   0
         Tag             =   "Código de Rango|N|N|0|999|cabrangos|codigo|000|S|"
         Top             =   480
         Width           =   855
      End
      Begin VB.TextBox text1 
         ...
         MaxLength       =   40
         TabIndex        =   1
         Tag             =   "Descripción|T|N|||cabrangos|descripcion|||"
         Top             =   480
         Width           =   4440
      End
...
Private Sub MandaBusquedaPrevia(CadB As String)
    ...
    If cad <> "" Then
        ...
        frmB.vTitulo = "Rangos Horarios" ' ***** repasa açò: títol de BuscaGrid *****
        frmB.vSelElem = 1
