...
Begin VB.Form frmManGrupo 
   ...
   Begin VB.Frame FrameAux0 
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   6
         TabIndex        =   17
         Tag             =   "Código de empresa|N|N|1|999999|sligru|codempre|000000|S|"
         Top             =   4080
         Visible         =   0   'False
         Width           =   975
      End
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   6
         TabIndex        =   13
         Tag             =   "Código de Socio|N|N|1|999999|sligru|codsocio|000000|S|"
         Top             =   4080
         Visible         =   0   'False
         Width           =   975
      End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox text1 
         ...
         MaxLength       =   6
         TabIndex        =   0
         Tag             =   "Código de grupo |N|N|0|999999|scagru|codempre|000000|S|"
         Top             =   270
         Width           =   855
      End
      Begin VB.TextBox text1 
         ...
         MaxLength       =   40
         TabIndex        =   1
         Tag             =   "Nombre|T|N|||scagru|nomempre|||"
         Top             =   270
         Width           =   4140
      End
...
Private WithEvents frmCli As frmManClien 'mantenimineto de clientes
...
Dim i As Integer
    ...
    Data1.RecordSource = "Select * from " & NombreTabla & " where codempre=-1"
    Data1.Refresh
...
Dim tabla As String
    ...
    Select Case Index
        ...
        Case 0 'lienas de grupo
            SQL = "SELECT sligru.codempre, sligru.codsocio, ssocio.nomsocio "
            SQL = SQL & " FROM sligru, ssocio "
            If enlaza Then
                SQL = SQL & ObtenerWhereCab(True)
            Else
                SQL = SQL & " WHERE sligru.codempre = -1"
            End If
            SQL = SQL & " and sligru.codsocio = ssocio.codsocio "
            SQL = SQL & " ORDER BY sligru.codempre"
...
'socios
    ...
    text2(0).Text = RecuperaValor(CadenaSeleccion, 2) 'nombre socio
...
Private Sub BotonAnyadir()
    ...
    text1(0).Text = SugerirCodigoSiguienteStr("scagru", "codempre")
...
Dim cad As String
    ...
    ' *************** canviar la pregunta ****************
    cad = "¿Seguro que desea eliminar el Grupo?"
...
EEliminar:
    Screen.MousePointer = vbDefault
    If Err.Number > 0 Then MuestraError Err.Number, "Eliminar Grupo", Err.Description
End Sub
...
Dim vWhere As String
    ...
    vWhere = " WHERE codempre=" & Data1.Recordset!codEmpre
        
    ' ***** elimina les llínies ****
    Conn.Execute "DELETE FROM sligru " & vWhere
...
Dim Nuevo As Boolean
    ...
    Select Case Index
        ...
        Case 6, 8, 9, 10, 13 'STOCKS Y PRECIOS
'### [Monica] 25/09/2006
...
Dim Eliminar As Boolean
    ...
    Select Case Index
        Case 0 'tarifas
            SQL = "¿Seguro que desea eliminar el Socio?"
            SQL = SQL & vbCrLf & "Socio: " & AdoAux(Index).Recordset!codsocio
            If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
                Eliminar = True
                SQL = "DELETE FROM sligru"
                SQL = SQL & vWhere & " AND codsocio= " & AdoAux(Index).Recordset!codsocio
            End If
    ...
    Select Case Index
        Case 1 ' socio
            If PonerFormatoEntero(txtAux(Index)) Then
                text2(0).Text = PonerNombreDeCod(txtAux(Index), "ssocio", "nomsocio")
                If text2(0).Text = "" Then
                    MsgBox "No existe el cliente. Revise.", vbExclamation
...
Dim vFact As Byte, vDocum As Byte
    ...
    ' ******************************************************************************
    SQL = ""
    SQL = DevuelveDesdeBDNew(cPTours, "sligru", "codsocio", "codempre", txtAux(0).Text, "N", , "codsocio", txtAux(1).Text, "N")
    If SQL <> "" Then
        MsgBox "Ese socio ya existe en el grupo. Reintroduzca.", vbExclamation
        b = False
    End If
    DatosOkLlin = b
...
Dim tots As String
    ...
    Select Case Index
        Case 0 'tarifas
            ...
            tots = "N||||0|;" 'codempre
            tots = tots & "S|txtAux(1)|T|Cliente|1200|;"
            tots = tots & "S|btnBuscar(0)|B|||;"
            tots = tots & "S|text2(0)|T|Nombre|4500|;"
...
Dim vWhere As String
    ...
    vWhere = vWhere & " codempre=" & Val(text1(0).Text)
