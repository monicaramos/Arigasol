...
Begin VB.Form frmEstCliArtAje 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Ventas Artículos por Cliente de Ajena"
   ClientHeight    =   6315
   ClientLeft      =   45
   ClientTop       =   2430
   ClientWidth     =   7185
   Icon            =   "frmEstCliArtAje.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6315
   ...
   Begin VB.Frame FrameCobros 
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   5
         Left            =   1545
         MouseIcon       =   "frmEstCliArtAje.frx":000C
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   4
         Left            =   1560
         MouseIcon       =   "frmEstCliArtAje.frx":015E
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar familia"
         Top             =   3000
         Width           =   240
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   2
         Left            =   1530
         Picture         =   "frmEstCliArtAje.frx":02B0
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   3
         Left            =   1530
         Picture         =   "frmEstCliArtAje.frx":033B
         ToolTipText     =   "Buscar fecha"
         Top             =   2280
         Width           =   240
      End
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   0
         Left            =   1560
         MouseIcon       =   "frmEstCliArtAje.frx":03C6
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgBuscar 
         ...
         Index           =   1
         Left            =   1545
         MouseIcon       =   "frmEstCliArtAje.frx":0518
         MousePointer    =   4  'Icon
         ToolTipText     =   "Buscar cliente"
         Top             =   1215
         Width           =   240
   ...
   End
End
Attribute VB_Name = "frmEstCliArtAje"
...
InicializarVbles
    ...
    cadTABLA = "(((schfacr INNER JOIN slhfacr on schfacr.numfactu = slhfacr.numfactu and schfacr.letraser = slhfacr.letraser and schfacr.fecfactu = slhfacr.fecfactu) "
    cadTABLA = cadTABLA & " INNER JOIN sartic ON slhfacr.codartic=sartic.codartic )"
...
'    cadTABLA = "(slhfac INNER JOIN sartic ON slhfac.codartic=sartic.codartic) "
    ...
    If HayRegParaInforme(cadTABLA, cadSelect) Then
       cadTitulo = "Ventas Artículos por Cliente Ajena"
       cadNombreRPT = "rEstCliartAje.rpt"
       LlamarImprimir
       'AbrirVisReport
    End If
End Sub
