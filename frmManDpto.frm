...
Begin VB.Form frmManDpto 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   40
      TabIndex        =   1
      Tag             =   "Nombre Departamento|T|N|||departamento|nomdepar|||"
      Top             =   4920
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código Departamento|N|N|0|9999|departamento|coddepar|0000|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManDpto.frx":000C
      Height          =   4410
      Left            =   120
      TabIndex        =   4
      Top             =   540
...
Private Sub BotonAnyadir()
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("departamento", "coddepar")
    End If
    '********************************************************************
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    If MsgBox(sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        sql = "Delete from departamento where coddepar=" & adodc1.Recordset!coddepar
        Conn.Execute sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "coddepar=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT coddepar, nomdepar FROM departamento"
    '************************************************************************
...
'    DataGrid1.RowHeight = 290
    ...
    tots = "S|txtAux(0)|T|Código|800|;S|txtAux(1)|T|Nombre|4557|;"
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "departamento"
        .Informe2 = "rManDpto.rpt"
        If CadB <> "" Then
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomEmpre & "'|pOrden={departamento.coddepar}|"
