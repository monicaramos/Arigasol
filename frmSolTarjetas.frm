...
Begin VB.Form frmSolTarjetas 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Solicitud Tarjetas Gasolinera"
   ClientHeight    =   5925
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8055
   Icon            =   "frmSolTarjetas.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5925
   ...
   Begin VB.ComboBox Combo1 
      Appearance      =   0  'Flat
      Height          =   315
      ItemData        =   "frmSolTarjetas.frx":000C
      Left            =   3270
      List            =   "frmSolTarjetas.frx":000E
      Style           =   2  'Dropdown List
      TabIndex        =   1
      Tag             =   "Tipo Tarjeta|N|N|0|1|soltarje|tiptarje||S|"
      Top             =   4920
      Width           =   735
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   2
      Tag             =   "Numero de Tarjetas|N|N|||soltarje|numtarje|0||"
      Top             =   4950
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   0
      Tag             =   "Código de Socio|N|N|0|999999|soltarje|codsocio|000000|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmSolTarjetas.frx":0010
      Height          =   4410
      Left            =   120
      TabIndex        =   7
      Top             =   540
   ...
   End
End
Attribute VB_Name = "frmSolTarjetas"
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    sql = "¿Seguro que desea eliminar la Solicitud del Cliente?"
    ...
    If MsgBox(sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        sql = "Delete from soltarje where codsocio= " & DBSet(adodc1.Recordset!codsocio, "N")
        sql = sql & " and tiptarje = " & DBSet(adodc1.Recordset!tiptarje, "N")
        Conn.Execute sql
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
...
Private Sub Form_Load()
    ...
    With Me.Toolbar1
        ...
        .Buttons(10).Image = 22 ' grabar en diskette
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT soltarje.codsocio, ssocio.nomsocio, soltarje.tiptarje, CASE soltarje.tiptarje WHEN 0 THEN ""Normal"" WHEN 1 THEN ""Bonificada"" END, "
    CadenaConsulta = CadenaConsulta & " soltarje.numtarje FROM soltarje, ssocio WHERE soltarje.codsocio = ssocio.codsocio"
    '************************************************************************
...
Private Sub mnGrabarDiskette_Click()
    frmGrabarDisk.Show vbModal
    CargaGrid
End Sub
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    sql = sql & " ORDER BY codsocio, tiptarje"
    '**************************************************************++
...
'    DataGrid1.RowHeight = 290
    ...
    tots = "S|txtAux(0)|T|Cliente|900|;S|btnBuscar(0)|B||195|;S|text2(0)|T|Nombre|3987|;"
    tots = tots & "N||||0|;S|Combo1|C|Tipo|1200|;S|txtAux(1)|T|Tarjetas|1100|;"
...
Dim Mens As String
    ...
    If Modo = 3 Then   'Estamos insertando
        sql = ""
        sql = DevuelveDesdeBDNew(cPTours, "soltarje", "codsocio", "codsocio", txtAux(0).Text, "N", , "tiptarje", Combo1.ListIndex, "N")
        If sql <> "" Then
            b = False
        End If
'       If ExisteCP(txtAux(0)) Then b = False
    ...
    If (Modo = 3) Or (Modo = 4) Then 'insertar o modificar
        ...
        If Combo1.ItemData(Combo1.ListIndex) > 0 Then
            sql = "SELECT COUNT(*) FROM soltarje WHERE tiptarje=" & Combo1.ItemData(Combo1.ListIndex) & " and codsocio=" & txtAux(0).Text
            If RegistrosAListar(sql) > 0 Then
               Mens = "Solo puede existir una socio con ese TIPO."
