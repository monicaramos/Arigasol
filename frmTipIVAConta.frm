...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT codigiva,nombriva,porceiva,CASE tipodiva WHEN 0 THEN ""IVA"" WHEN 1 THEN ""IGIC"" WHEN 2 THEN ""BIEN DE INVERSIÓN"" WHEN 3 THEN ""R.E.A."" END,porcerec,cuentare,cuentarr,cuentaso,cuentasr,cuentasn FROM tiposiva "
    '************************************************************************
    CadB = ""
    CargaGrid
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    tots = tots & "S|txtAux(2)|T|%IVA|600|;S|Combo1(0)|C|Tipo|1100|;"
