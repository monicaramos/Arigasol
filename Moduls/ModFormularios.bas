...
'  7 -> Decimal(10,5) precio de compra en albaranes de compra y en la ficha del articulo
Dim Valor As Double
...
'                    .Text = ""
        ...
        Select Case tipoF 'Comprobar longitud
            ...
            Case 7 'decimal(10,5)
                If Len(CStr(PEntera)) > 5 Then
                    MsgBox "El valor no puede ser mayor de 99999,99999", vbExclamation
                    NoOK = True
                End If
...
'                .Text = ""
            ...
            Select Case tipoF
                ...
                Case 7 'Formato Decimal(10,5)
                    .Text = Format(Valor, FormatoDec10d5)
            End Select
...
'                        End If
                        ...
                        Select Case tipoMov
                            Case "OFE", "PEV", "ALV", "AL1", "ALR", "FAV": If vArtic.TextoVentas <> "" Then vArtic.MostrarTextoVen
