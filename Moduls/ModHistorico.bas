...
On Error Resume Next
    ...
    Select Case CodTipoMov
      Case "PEV" 'pedidos de venta a clientes
        NomTabla = "scaped"
        NomTablaH = "schped"
        SQL = " SELECT numpedcl,fecpedcl," & vSesion.Codigo Mod 1000 & " as codigusu," & cadL & ","
      ...
      Case "ALV", "AL1", "ALM" 'Albaran de venta a clientes
        NomTabla = "scaalb"
        NomTablaH = "schalb"
        SQL = " SELECT codtipom,numalbar,fechaalb," & vSesion.Codigo Mod 1000 & " as codigusu," & cadL & ","
      ...
      Case "ALC" 'Albaranes a Proveedores (Compras)
        NomTabla = "scaalp"
        NomTablaH = "schalp"
        SQL = " SELECT numalbar,fechaalb,codprove," & vSesion.Codigo Mod 1000 & " as codigusu,''," ' & cadl & ","
...
'        SQL = SQL & "codforpa,codtraba,codtrab1,dtoppago,dtognral,"
      ...
      Case "PEC" 'Pedidos a Proveedores (Compras)
        NomTabla = "scappr"
        NomTablaH = "schppr"
        SQL = " SELECT numpedpr,fecpedpr," & vSesion.Codigo Mod 1000 & " as codigusu," & cadL & ","
