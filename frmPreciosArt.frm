...
Begin VB.Form frmPreciosArt 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   1
      Tag             =   "Código de Articulo|N|N|0|999999|tmpinformes|codigo1|000000|S|"
      Top             =   4350
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   12
      TabIndex        =   3
      Tag             =   "Precio Ultima Compra|N|N|||tmpinformes|precio2|##,##0.00000||"
      Top             =   4350
      Width           =   1395
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   40
      TabIndex        =   2
      Tag             =   "Nombre|T|N|||tmpinformes|nombre1|||"
      Top             =   4350
      Width           =   1395
   End
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmPreciosArt.frx":000C
      Height          =   4410
      Left            =   120
      TabIndex        =   8
      Top             =   540
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   0
      Tag             =   "Usuario|N|N|0|999999|tmpinformes|codusu|000000|S|"
      Top             =   5310
      Width           =   800
   End
   ...
   End
End
Attribute VB_Name = "frmPreciosArt"
...
Dim b As Boolean
    ...
    txtAux(1).visible = (Modo = 1 Or Modo = 4)
    txtAux(2).visible = False
    txtAux(3).visible = (Modo = 1 Or Modo = 4)
    ...
    BloquearTxt txtAux(1), Modo <> 1
    BloquearTxt txtAux(2), True
    BloquearTxt txtAux(3), Not (Modo = 1 Or Modo = 4)
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT codusu, codigo1, nombre1, precio2 from tmpinformes where codusu = " & vSesion.Codigo
    '************************************************************************
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    sql = sql & " ORDER BY codusu, codigo1"
    '**************************************************************++
...
'    DataGrid1.RowHeight = 290
    ...
    tots = "N||||0|;S|txtAux(1)|T|Código|1000|;S|txtAux(2)|T|Descripción|3187|;S|txtAux(3)|T|Precio|1600|;"
...
Private Sub txtAux_LostFocus(Index As Integer)
    ...
    Select Case Index
        Case 0, 1 ' codigo de articulo
            PonerFormatoEntero txtAux(Index)
        Case 3 ' preciom de ultima compra
