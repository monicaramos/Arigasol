...
Begin VB.Form frmManEntidades 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   2
      TabIndex        =   6
      Tag             =   "Provincia|N|N|||entidaddom|proentidad|00||"
      Top             =   4950
      Width           =   765
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   36
      TabIndex        =   5
      Tag             =   "Poblacion|T|N|||entidaddom|pobentidad|||"
      Top             =   4920
      Width           =   1905
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   4
      Tag             =   "C.Postal|T|N|||entidaddom|codpostal|||"
      Top             =   4920
      Width           =   975
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   36
      TabIndex        =   3
      Tag             =   "Domicilio|T|N|||entidaddom|domentidad|||"
      Top             =   4920
      Width           =   3945
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   2
      Tag             =   "Sucursal|N|N|||entidaddom|codsucur|0000|S|"
      Top             =   4920
      Width           =   975
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   40
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||entidaddom|nomentidad|||"
      Top             =   4920
      Width           =   3945
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código Entidad|N|N|0|9999|entidaddom|codentidad|0000|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManEntidades.frx":000C
      Height          =   4410
      Left            =   120
      TabIndex        =   11
      Top             =   540
...
Dim i As Integer
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("entidaddom", "codentidad")
    End If
    '********************************************************************
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    Sql = "¿Seguro que desea eliminar la Entidad Domiciliaria?"
    Sql = Sql & vbCrLf & "Código: " & adodc1.Recordset.Fields(0)
    Sql = Sql & vbCrLf & "Descripción: " & adodc1.Recordset.Fields(1)
    Sql = Sql & vbCrLf & "Sucursal: " & adodc1.Recordset.Fields(2)
    
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        'Hay que eliminar
        NumRegElim = adodc1.Recordset.AbsolutePosition
        
        Sql = "Delete from entidaddom where codentidad=" & adodc1.Recordset!codentidad
        Sql = Sql & " and codsucur = " & adodc1.Recordset!codsucur
        ...
        Case 4 'MODIFICAR
            If DatosOk Then
                If ModificaDesdeFormulario(Me) Then
                    ...
                    CargaGrid CadB
                    SituarDataMULTI adodc1, "codentidad = " & txtAux(0) & " and codsucur = " & txtAux(2), Me.lblIndicador, True
'
                    PonerModo 2
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "codentidad=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT * FROM entidaddom"
    '************************************************************************
...
'    adodc1.ConnectionString = Conn
    ...
    End If
    '********************* canviar el ORDER BY *********************++
    Sql = Sql & " ORDER BY codentidad, codsucur"
    '**************************************************************++
...
'    DataGrid1.RowHeight = 290
    ...
    tots = "S|txtAux(0)|T|Código|700|;S|txtAux(1)|T|Nombre|3700|;"
    tots = tots & "S|txtAux(2)|T|Sucursal|800|;S|txtAux(3)|T|Domicilio|3400|;S|txtAux(4)|T|CPostal|700|;"
    tots = tots & "S|txtAux(5)|T|Poblacion|3400|;S|txtAux(6)|T|PR|400|;"
...
Dim Mens As String
    ...
    If Modo = 3 Then   'Estamos insertando
         Sql = "select count(*) from entidaddom where codentidad = " & txtAux(0).Text & " and codsucur = " & txtAux(2).Text
         If TotalRegistros(Sql) <> 0 Then
             MsgBox "Entidad / Sucursal ya existe. Revise.", vbExclamation
             b = False
         End If
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "enitdaddom"
        .Informe2 = "rManEntidades.rpt"
        If CadB <> "" Then
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomEmpre & "'|pOrden={entidaddom.codentidad}|"
